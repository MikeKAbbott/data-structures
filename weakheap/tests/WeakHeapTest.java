...
public class WeakHeapTest {
    ...
    public void setUp() {
        ...
        TreePrinter.print(wh1.getElem(0));
    ...
    @Test
    public void extractMin() throws RootE, NoLeftChildE {
    ...
    public void setUp2() {
        ...
        wh2.insert(new Item(80));
        wh2.insert(new Item(90));
        wh2.insert(new Item(110));
        wh2.insert(new Item(180));
        wh2.insert(new Item(190));
        wh2.insert(new Item(170));
        wh2.insert(new Item(200));
        wh2.insert(new Item(210));
        wh2.insert(new Item(120));
        wh2.insert(new Item(8));
        wh2.insert(new Item(5));
        wh2.insert(new Item(2));
        wh2.insert(new Item(0));
        wh2.insert(new Item(1));
        wh2.insert(new Item(3));
        TreePrinter.print(wh2.getElem(0));
        assertTrue(wh2.checkOrder());

    }

    @Test
    public void getLeftMostChildIndex3() throws NoLeftChildE {
        assertEquals(15, wh2.getLeftMostChildIndex());
    }

    @Test
    public void swap2() {
        assertEquals(1, wh2.getValue(1));
        assertEquals(20, wh2.getValue(2));
        wh2.swap(1, 2);
        assertEquals(1, wh2.getValue(2));
        assertEquals(20, wh2.getValue(1));

        assertEquals(90, wh2.getValue(4));
        assertEquals(110, wh2.getValue(5));
        wh2.swap(4, 5);
        assertEquals(90, wh2.getValue(5));
        assertEquals(110, wh2.getValue(4));

        assertEquals(210, wh2.getValue(10));
        assertEquals(120, wh2.getValue(11));
        wh2.swap(11, 10);
        assertEquals(210, wh2.getValue(11));
        assertEquals(120, wh2.getValue(10));

    }

    @Test
    public void insert2() {
        wh2.insert(new Item(202));
        assertTrue(wh2.checkOrder());
        wh2.insert(new Item(313));
        assertTrue(wh2.checkOrder());
        wh2.insert(new Item(211));
        assertTrue(wh2.checkOrder());
        wh2.insert(new Item(332));
        assertTrue(wh2.checkOrder());
        wh2.insert(new Item(154));
        assertTrue(wh2.checkOrder());
        wh2.insert(new Item(164));
        assertTrue(wh2.checkOrder());
        wh2.insert(new Item(170));
        assertTrue(wh2.checkOrder());
        wh2.insert(new Item(200));
        assertTrue(wh2.checkOrder());
        wh2.insert(new Item(151));
        assertTrue(wh2.checkOrder());
    }

    @Test
    public void moveUp2() {
        wh2.getElem(10).setValue(0);
        wh2.moveUp(10);
        assertEquals(0, wh2.getValue(0));
        assertEquals(0, wh2.getValue(1));
        assertEquals(1, wh2.getValue(2));
        assertEquals(5, wh2.getValue(3));
        assertEquals(90, wh2.getValue(4));
        assertTrue(wh2.checkOrder());
    ...
    public void getRightChildIndex2() throws NoRightChildE {
        assertEquals(1, wh2.getValue(wh2.getRightChildIndex(0)));
        assertEquals(20, wh2.getValue(wh2.getRightChildIndex(1)));
        assertEquals(110, wh2.getValue(wh2.getRightChildIndex(2)));
        assertEquals(170, wh2.getValue(wh2.getRightChildIndex(8)));
        assertEquals(200, wh2.getValue(wh2.getRightChildIndex(4)));
    }
    ...
    public void join2() {
        ...
        wh2.getElem(4).setValue(10);
        assertTrue(wh2.join(0, 4));
        assertEquals(0, wh2.getValue(0));
        assertEquals(1, wh2.getValue(1));
        assertEquals(20, wh2.getValue(2));
        assertEquals(5, wh2.getValue(3));
        assertEquals(10, wh2.getValue(4));
    }
    @Test
    public void weakHeapify2() {
        Random r = new Random(1);
        ArrayList<Item> items = new ArrayList<>();
        for (int i = 0; i < 7; i++) {
            items.add(new Item(r.nextInt(1000)));
        }
        WeakHeap w = new WeakHeap(items);
        assertEquals(254, w.getValue(0));
        assertEquals(313, w.getValue(1));
        assertEquals(847, w.getValue(2));
        assertEquals(434, w.getValue(3));
        assertEquals(985, w.getValue(4));
        assertEquals(904, w.getValue(5));
        assertTrue(w.checkOrder());
    }
}